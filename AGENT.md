...
| 回归复核（BRAM 属性之后） | `bash scripts/run_full_regression.sh` → **`FULL_REGRESSION: PASS （PASS 计数=281 / FAIL 计数=7）`，偏离基线清单为空**；`hello` 308 拍、`memtest` **1,021,800 拍**（与加属性前逐项一致 ⇒ 属性对仿真无影响，已核实） |
